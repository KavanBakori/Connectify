...
function First() {
  ...
  function fetchData() {
    ...
    devicesRef.doc("device")
      ...
      .catch(function (error) {
        console.error("Error fetching document: ", error);
        alert("Error fetching document. Please connect with the internet!");
      });
  }
  ...
  return (
        <>
          ...
          <main>
            <Container style={{ marginTop: `30px` }}>
              <Nav variant="pills" defaultActiveKey="/home" style={{ float: `right` }}>
                <Nav.Item>
                  <Nav.Link href="/login" style={{backgroundColor:`green`,color:`white`}}>Administrator Login</Nav.Link>
                </Nav.Item>
              </Nav>
              <Carousel style={{ height: '400px', width: '800px', margin: `auto`, marginBottom: `30px`, marginTop: `30px`,backgroundColor:`black` }}>
                <Carousel.Item interval={1000} >
      ...
      <Accordion.Item eventKey="0">
        <Accordion.Header>NVIDIA Workstation</Accordion.Header>
        <Accordion.Body>
        <Card style={{ width: "auto",boxShadow:"0 0 30px 0 #dcdcdc",borderColor:"transparent",display:'flex',flexDirection:'row',columnGap:'40px',justifyContent:'center' }}>
                      <Card.Img
                         variant="top"
                      ...
                      <Card.Body>
                        ...
                        <Card.Text>
                         ...
                         <span style={{fontWeight:`bold`}}>VR Ready:</span>Yes<br></br>
                          ...
                          <span style={{ fontSize: `20px`, fontWeight: `bold` }}>Currently Available device:</span> <span style={{fontSize:`30px`,fontWeight:`bold`,color:`green`}}>{newData.new1}</span>
                        </Card.Text>
                       <Link to="/req1" style={{textDecoration:"none",float:'right'}}><Button variant="success">Send Request</Button></Link> 
                      </Card.Body>
                    </Card>
        </Accordion.Body>
      </Accordion.Item>
                  ...
                  <Accordion defaultActiveKey="0" flush>
      <Accordion.Item eventKey="0">
        <Accordion.Header>NVIDIA Jetson Nano Developer Kit</Accordion.Header>
        <Accordion.Body>
        <Card style={{ width: "auto",boxShadow:"0 0 30px 0 #dcdcdc",borderColor:"transparent",display:'flex',flexDirection:'row',columnGap:'40px',justifyContent:'center',alignItems:'center' }}>
                      <Card.Img
                        variant="top"
                        src="assets/third.jpg"
                        style={{width:`auto`,height:`370px`,width:'300px',margin:`auto`}}

                        
                      />
                      <Card.Body>
                        {/* <Card.Title>NVIDIA Jetson Nano Developer Kit</Card.Title> */}
                        <Card.Text
                        ...
                        >
                         ...
                         <ul>
                          ...
                          <span style={{ fontSize: `20px`, fontWeight: `bold` }}>Currently Available device:</span> <span style={{fontSize:`30px`,fontWeight:`bold`,color:`green`}} >{newData.new2}</span>
                        </Card.Text>
                        <Link to="/req2" style={{textDecoration:"none",float:'right'}}><Button variant="success">Send Request</Button></Link> 
                      </Card.Body>
                    </Card>
        </Accordion.Body>
      </Accordion.Item>
                  ...
                  <Accordion defaultActiveKey="0" flush>
      <Accordion.Item eventKey="0">
        <Accordion.Header>NVIDIA DGX Station A100</Accordion.Header>
        <Accordion.Body>
        <Card style={{ width: "auto",boxShadow:"0 0 30px 0 #dcdcdc",borderColor:"transparent",display:'flex',flexDirection:'row',columnGap:'40px',justifyContent:'center' }}>
                      <Card.Img
                        variant="top"
                      ...
                      <Card.Body>
                        ...
                        <br></br>
                         ...
                         <span style={{fontWeight:`bold`}}>Operating Temperature:</span>  5–35 ºC (41–95 ºF)<br></br>
                          ...
                          <span style={{ fontSize: `20px`, fontWeight: `bold` }}>Currently Available device:</span><span style={{fontSize:`30px`,fontWeight:`bold`,color:`green`}} >{newData.new3}</span>
                        </Card.Text>
                        <Link to="/req3" style={{textDecoration:"none",float:'right'}}><Button variant="success" >Send Request</Button></Link> 
                      </Card.Body>
                    </Card>
        </Accordion.Body>
      </Accordion.Item>
